# signature.py
# compute Enigma signature given a configuration
...
def main():
    ...
    parser.add_argument(
        'config', help="m for manual testing, c for problem 4. -c will ignore all subsequent inputs", choices=config)
    ...
    parser.add_argument(
        'fast_rotor', help="fast [right] rotor", choices=rotors)
                            ...
                            for first_ltr in ALPHABET:
                                for second_ltr in ALPHABET:
                                    for third_ltr in ALPHABET:
                                        ...
                                        txt = slow + " " + med + " " + fast + " " + "\"" + first_ltr + \
                                            second_ltr+third_ltr+"\"" + \
                                            "," + str(sig) + "\n"
                                        file.write(txt)
                                        # else:
                                        #     file.close()
